            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white dark:bg-neutral-800 p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                  <button
                    type="button"
                    className="absolute top-2 right-2 z-10 w-fit p-2 bg-primary-100 dark:bg-neutral-700 rounded-full"
                    onClick={closeModal}
                  >
                    <Image
                      src="/close.svg"
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1 relative w-full h-24 bg-primary-100 dark:bg-neutral-700 rounded-lg">
                        <Image
